export const projects = [
  ...
  // ==========================================
  {
    ...
    tags: ['HTML5', 'Vue 3', 'SCSS', 'Quasar', 'gulp', 'WAI-ARIA'],
    detail: {
      id: 'nara-sarang',
      ...
      features: [
        ...
        {
          // images: [
          //   '/images/nara_a11y_keyboard.png', // 키보드 포커스 화면
          //   '/images/nara_a11y_voiceover.png', // 보이스오버 동작 화면
          // ],
        ...
        {
          images: [
            '/images/nara_preregi_pc.png', // 사전신청 PC 화면
            '/images/nara_preregi_mo.png', // 사전신청 모바일 화면
          ],
          text: '나라사랑카드 사전신청 페이지 퍼블리싱. Quasar 공통 컴포넌트를 활용해 하나·IBK·신한 3개 카드사 UI를 일관된 구조로 구현했습니다.',
        },
      ],
      challenges: [
        {
        ...
        {
          problem:
            '신분 유형(현역/예비역/부사관)에 따라 화면 구성과 기능이 달라 분기 처리가 복잡해졌습니다.',
          solution:
